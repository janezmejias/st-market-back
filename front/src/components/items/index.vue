    ...
    >
      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          ...
          <q-td key="oldPrice" :props="props">{{ roundValue(props.row.oldPrice) }}</q-td>
          <q-td key="newPrice" :props="props">{{ roundValue(props.row.newPrice) }}</q-td>
          <q-td key="id">
...
export default {
  ...
  methods: {
    listAll() {
      this.$axios.get("/product/listAll").then(response => {
    ...
    remove() {
      this.$axios
        .delete("/product/delete?id=" + this.model.id)
        .then(response => {
          this.listAll();
          this.confirm = false;
        });
